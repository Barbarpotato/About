...
import {
  Box, Container, Heading, Text, Image, Flex, Tabs, TabList,
  Tab, TabPanels, TabPanel, Progress, Badge, Button, Grid,
  GridItem, VStack, HStack, Icon, Card, CardBody,
} from '@chakra-ui/react';
import {
  FaCode, FaServer, FaMobileAlt, FaChartBar,
  FaBrain, FaRocket, FaLightbulb, FaStar,
} from 'react-icons/fa';
        ...
        <Box py={{ base: 8, md: 12 }} borderBottomWidth={1} borderColor="#536189">
          <Box maxW="7xl" mx="auto" px={{ base: 4, md: 6 }}>
            ...
            <Text fontSize={{ base: 'md', md: 'lg' }} color="#faf9ff" maxW="2xl">
              Describing myself as a software engineer with a strong focus on software development and architecture.
            </Text>
          </Box>
        </Box>
